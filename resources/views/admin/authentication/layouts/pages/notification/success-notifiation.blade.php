<div class="jq-toast-wrap top-right" id="alertbottomleft">
    <div class="jq-toast-single jq-has-icon jq-icon-success" style="text-align: left;"><span
        ...
        <h2 class="jq-toast-heading"> {{ session('message') }}</h2>
    </div>
</div>