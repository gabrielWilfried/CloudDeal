...
class AboutGuestController extends Controller
{
    public function index()
    {
        ...
        $images = [asset("assets/images/Apropos/genie.png"), asset("assets/images/Apropos/mariane.png"), asset("assets/images/Apropos/gaby.png"), asset("assets/images/Apropos/vane.png"), asset("assets/images/Apropos/sagesse.png"), asset("assets/images/Apropos/fideline.png"), asset("assets/images/Apropos/jordan.png"), asset("assets/images/Apropos/ines.png"), asset("assets/images/Apropos/geovanni.png"), asset("assets/images/Apropos/samira.png"), asset("assets/images/Apropos/dorine.png")];
